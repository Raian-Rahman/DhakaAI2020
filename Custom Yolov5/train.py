...
if __name__ == '__main__':
    ...
    if not opt.evolve:
        ...
        if opt.global_rank in [-1, 0]:
            ...
            tb_writer = SummaryWriter(log_dir=increment_dir('/content/drive/MyDrive/Dhaka AI Image Classification Competition/Training Checkpoint Test/Exp',opt.name))  # runs/exp0
